    ...
    */
    ...
    case 2:
        ...
        do {
            ...
            gotoxy(0, 12);
            cout << "\nTurno de: " << name << " | " << "Lanzamiento" << lanzamiento << " | " << total_points_1;
            cout << "\nJugar de vuelta? S/N\n";

            if (total_points_1 == 10000)
                break;
            ...
            do {
                ...
                gotoxy(0, 12);
                cout << "\nTurno de: " << name2 << " | " << "Lanzamiento " << lanzamiento << " | " << total_points_2;
                cout << "\nJugar de vuelta? S/N\n";

                if (total_points_2 == 10000)
                        break;
